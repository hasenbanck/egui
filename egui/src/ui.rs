...
impl Ui {
    ...
    pub fn set_min_size(&mut self, size: Vec2) {
        debug_assert_eq!(self.min_rect.min, self.max_rect.min);
        debug_assert!(!self.layout.is_reversed());
    ...
    pub fn set_min_width(&mut self, width: f32) {
        debug_assert_eq!(self.min_rect.min, self.max_rect.min);
        debug_assert!(!self.layout.is_reversed());
        self.min_rect.max.x = self.min_rect.max.x.at_least(self.min_rect.max.x + width);
        self.max_rect.max.x = self.max_rect.max.x.at_least(self.max_rect.max.x + width);
    }

    pub fn set_min_height(&mut self, height: f32) {
        debug_assert_eq!(self.min_rect.min, self.max_rect.min);
        debug_assert!(!self.layout.is_reversed());
        self.min_rect.max.y = self.min_rect.max.y.at_least(self.min_rect.max.y + height);
        self.max_rect.max.y = self.max_rect.max.y.at_least(self.max_rect.max.y + height);
    }
